...
CREATE TABLE `salestable` (
  ...
  KEY `prod_id` (`prod_id`),
  KEY `id` (`id`),
  CONSTRAINT `salestable_ibfk_1` FOREIGN KEY (`prod_id`) REFERENCES `productstable` (`prod_id`),
  CONSTRAINT `salestable_ibfk_2` FOREIGN KEY (`id`) REFERENCES `customerstable` (`id`)
...
INSERT INTO `salestable` VALUES (1,1,4,67,24120.00),(2,1,1,56,20160.00);
...
-- Dump completed on 2025-06-23 10:16:27
